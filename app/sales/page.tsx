...
export default function SalesPage() {
  ...
  useEffect(() => {
    ...
    const ordersChannel = subscribeToOrders(MERCHANT_ID, (payload) => {
      if (payload.eventType === 'INSERT') {
        loadTransactions(); // Reload all transactions when new order comes in
      }
    });
  ...
  const viewTransactionDetails = async (transaction: TransactionData) => {
            ...
            <div className="mt-3">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium text-gray-900">
                  Transaction Details - {selectedTransaction.order_id.substring(0, 8)}...
                </h3>
                <button
                  ...
                  <div className="space-y-2">
                    {selectedTransaction.items.map((item, index) => (
                      <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded">
                        ...
                        <p className="font-semibold">{formatPrice(item.price_cents / 100)}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="border-t pt-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-bold text-green-600">
                      {formatPrice(selectedTransaction.total_cents / 100)}
                    </span>
                  </div>
                </div>
              </div>
