...
export default function MerchantProfilePage() {
  ...
  const username = cookieStore.get('merchant_user')?.value || 'Unknown'
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-3xl px-4 py-10">
        <div className="mb-6 flex items-center justify-between">
          ...
          <a href="/merchant/logout" className="text-sm text-gray-700 hover:underline">Logout</a>
        </div>
        ...
        <div className="bg-white text-gray-900 shadow rounded-lg p-6">
          ...
          <div className="mt-6 flex gap-3">
            <Link href="/merchant/dashboard" className="px-4 py-2 rounded-md bg-blue-600 text-white text-sm hover:bg-blue-700">Open Dashboard</Link>
